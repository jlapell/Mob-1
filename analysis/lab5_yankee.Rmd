...
fastfood_tx_mcd = fastfood %>% filter(state == "TX", startsWith(name, "McDonald"))
lq_tx_sample = lq_tx %>% slice_sample(n = nrow(fastfood_tx_mcd))

lq_mcd_tx = full_join(lq_tx_sample, fastfood_tx_mcd, by = "state")
nrow(lq_mcd_tx)
